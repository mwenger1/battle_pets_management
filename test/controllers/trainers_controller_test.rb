...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { class: @trainer.class, name: @trainer.name } }, as: :json
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { class: @trainer.class, name: @trainer.name } }, as: :json
    assert_response 200
  end
